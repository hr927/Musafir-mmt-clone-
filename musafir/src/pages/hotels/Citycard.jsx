...
const Citycard = (props) => {
    ...
    const {value1,
        ...
        value3,
        value4,
        value5 ,image, imgThumb1, imgThumb2, imgThumb3, rating, ratingText, ratingcount, name, location2, location, item, cancellation, freecancellation, offer, price, dscprice, pernight, tax, imgThumb4,text }=props
 const handleclick =()=>{
    navigate('/singlehotel');
    localStorage.setItem("hoteldetails",JSON.stringify(props))
